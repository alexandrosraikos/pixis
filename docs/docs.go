...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "models.Duty": {
            "description": "Duty is a task or responsibility assigned to conscripts, linked to a service, and can be assigned to many conscripts. Timestamps are managed by Gorm.",
            "type": "object",
            "properties": {
                "conscriptDuties": {
                    "type": "array",
